// app.js
const express = require('express'); //서버버
const cors = require('cors'); //보안
      ...
      messages: [
        {
          ...
          content: `
            ...
            2. summery: morning, afternoon, night으로 나누어 각각 1-2문장으로 요약하세요.
            3. question: 일기 내용과 관련된 의미 있는 질문을 하나 생성하세요.
            4. feelings: 일기에서 느껴지는 주요 emotion과 그 reason을 나누어서 설명하세요.
            example:
            {
